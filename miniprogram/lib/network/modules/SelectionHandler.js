...
import { SelectionAccumulator } from "./selection/index";
...
class SelectionHandler {
  ...
  _pointerToPositionObject(pointer) {
    // console.log('pointer', pointer, 'translation', this.body.view.translation, this.canvas.frame.canvas.width, this.canvas.frame.canvas.height)
