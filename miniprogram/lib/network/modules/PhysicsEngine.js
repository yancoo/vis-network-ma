...
} from "../../vis-util/esnext/esm/vis-util";
import { EndPoints } from "./components/edges/index"; // for debugging with _drawForces()
...
class PhysicsEngine {
  ...
  init() {
    let options;
    console.log('solver', this.options.solver, this.options)
